...
BUTTONSCONTACT = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/Karthik177")]])
keyboard = InlineKeyboardMarkup(
    [
        [
            InlineKeyboardButton(text="🛠️ JOIN", url="https://t.me/BotsByKk"),
            InlineKeyboardButton(text="🛠️ Contact", url="Https://t.me/Karthik177"),
        ],
    ]
)
...
async def start(bot, m: Message):
    ...
    if m.chat.id in AUTH_USERS:
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [KK BOTZ](https://t.me/KK_BOTZ)\n", disable_web_page_preview=True, reply_markup=BUTTONSCONTACT
        )
    else:
        ...
        await start_message.edit_text(
           ...
           f"<blockquote>💵 Monthly Plan: ₹130</blockquote>\n\n"
